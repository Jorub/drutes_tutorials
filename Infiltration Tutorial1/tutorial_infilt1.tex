...
\hline
& $\alpha$ & n & m &$ \theta_s$ &$ \theta_r$& Ss & $K_s$ \\
& cm$^{-1}$ & -  & - & - & - & cm d$^{-1}$ \\
Material & &   & &&\\
 \hline
Sand & 0.10 & 2.2  & 0.55 & 0.4 & 0  &1e-9 & 400\\
Silt & 0.08 & 2.0  & 0.50 & 0.45 & 0.05 & 1e-9& 40 \\
Clay & 0.01 & 1.5  & 0.33 & 0.5 & 0.1  &1e-10& 4 \\
\hline
\end{tabular}
}
\end{table}
...
\item Geometry information: 1000 cm - domain length
...
\item Length of interval for precalculating the constitutive functions: 500
