...
\begin{figure}[!h]
\centering
\includegraphics[width=8cm]{Fig_inf2/infilt.png}
...
\includegraphics[width=6cm]{Fig_inf2/retention_curve.png}
\includegraphics[width=6cm]{Fig_inf2/cond_hyd_curve.png}
